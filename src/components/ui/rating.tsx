// https://github.com/shadcn-ui/ui/issues/1107#issuecomment-2094679738
...
const ratingVariants = {
  ...
  yellow: {
    ...
    emptyStar: "text-yellow-500 dark:text-yellow-200",
  },
};
...
export const Ratings = ({
  ...
  variant = "default",
  onRatingChange,
  showText = false, // Default to true if disabled prop is not provided
  ...
  const partialStar =
    displayRating % 1 > 0 ? (
      <PartialStar
        ...
        size={size}
        className={cn(ratingVariants[variant].star, iconSizes[iconSize])}
        Icon={Icon}
      />
    ) : null;
